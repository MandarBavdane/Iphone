...
const VideoCarousel = () => {
    ...
    useEffect(() => {
        ...
        if(isPlaying) {
            gsap.ticker.add(animUpdate) //ticker is used to update progress bar
        } else {
    ...
    //video id is id for every video unitil id becomes number 3
            ...
            <div className="flex items-center">
                {highlightsSlides.map((list, i) => (
                    ...
                    rounded-3xl overflow-hidden bg-black">
                                <video id="video"
                                    playsInline={true} preload='auto' muted
                                    className={`${
